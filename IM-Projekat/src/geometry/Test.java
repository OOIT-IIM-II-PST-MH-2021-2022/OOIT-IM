...
public class Test {
	...
	public static void main(String[] args) {
		...
		//Vezbe 7 URIS
		/*DINAMICKO (KASNO) POVEZIVANJE - odnosi se na povezivanje naziva metode sa implementacijom (de�ava se tek prilikom izvr�enja programa)
		 Omogu�ava da se u vreme pisanja programa neka promenljiva deklari�e jednim tipom
		 dok se inicijalizacija vr�i pozivom konstruktora nekog drugog tipa (neke klase koja je izvedena):
		*/
		...
		/*
		 ...
		 Interpreter prilikom izvr�enja posmatra kako je promenljiva inicijalizovana i izvr�i�e se implementacija metode one klase kojom je promenljiva inicijalizovana 
		 (iz primera - area metoda klase Donut)
		 */
		
		/*Nizovi su stati�ke kolekcije koje omogu�avaju upravljanje sa vi�e objekata istog tipa pomo�u jedne promenljive
		 Prilikom deklaracije niza navodi se tip elemenata koje �e sadr�ati, a prilikom kreiranja (pomo�u operatora new) se navodi
		 maksimalna du�ina niza koja se dalje u kodu ne mo�e menjati
		...
		*/
		...
		//System.out.println(pointArray[0]); //Point nije primitivni tip podatka, kreira se niz �iji elementi imaju null vrednost
		pointArray[0] = p1;
		pointArray[1] = p2;
		pointArray[2] = p3;
		...
		/*Arrays klasa je definisana u java.utils paketu i sadr�i stati�ku sort metodu <public static void sort(Object[] a)>
		koja sortira elemente niza, pri �emu tip objekata koji se �uva u nizu mora da implementira Comparable interfejs -
		sort metoda sortira niz upore�ivaju�i elemente pozivom compareTo metode  
		*/
